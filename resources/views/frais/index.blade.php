...
@section('content')
  ...
  <div class="content-header">
    <div class="d-flex align-items-center">
      <div class="mr-auto">
        <h3 class="page-title">Frais Agence </h3>
...
<a type="button" class="btn btn-info btn-circle btn-sm" title="Noveau Bien"  href="/Fraisagence/Add"   ><i class="fa fa-plus"></i>      
</a>
      </div>
      </div>  
