...
@section('content')
    ...
    <div class="right-title">
        <div class="dropdown">
          ...
          <div class="dropdown-menu dropdown-menu-right">
            ...
            <a class="dropdown-item" href="/Document/Add/{{ $art->id }}"><i class="mdi mdi-file-document"></i>Document</a>
        ...
        <!-- /.col -->    
          ...
          <div class="col-12 col-lg-6">
            ...
            <ul class="nav nav-tabs">
              ...
              <li><a class="active" href="#usertimeline" data-toggle="tab">Biens</a></li>
 ...
 @foreach ($b->Location as $l)
                    ...
                    <div class="media px-0 mt-20">
                      ...
                      <div class="media-body">
                        <p>
                          <a href="/Locataire/{{ $l->locataire->id }}/View"><strong> {{ $l->locataire->prenom }}  {{ $l->locataire->nom }}  {{ $l->locataire->societe }}</strong></a>
                          <a style="font-size: 20px" class="float-right text-lighter" href="{{ Storage::url($l->path_contrat)}}"><i class="fa fa-file-text-o" aria-hidden="true"></i></a>
                        </p>
                        <p>{{ $l->date_debutbail }} => {{ $l->date_finbail }} || {{ $l->loyer }} MAD</p>
                      </div>
                    </div>
          ...
          <div class="media-body">
            <p>
            <strong>{{$doc->Groupname }} </strong>

  
            
            <a style="font-size: 20px" class=" button float-right text-lighter" href="{{ Storage::url($doc->path_doc)}}"><i class="fa fa-file-text-o" aria-hidden="true"></i></a>
            </p>
