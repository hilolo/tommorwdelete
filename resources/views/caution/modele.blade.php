...
@endif
                  ...
                  demeurant a {{$ar->location->bien->locataire->adresse}} représenté par Monsieur Brahim Lachaibi, titulaire de la C.I.N N° K304670 domicilié à Av Med 6, complexe Alia Bloc C N° 7. Tanger. Atteste avoir reçu,  de la part de:</td>
         ...
         <tr>
            <td><br> La  somme  de : <b> {{$ar->montant}} MAD </b> {{$loertext}} Dirhams Concernant  la caution relative à la location de l’appartement situé à    {{$ar->location->bien->adresse}}  {{$ar->location->bien->ville}}</td>
...
@endif
         ...
         <tr>
            <td><br> La  somme  de : <b> {{$ar->loyer}} MAD </b> {{$loertext}} Dirhams Concernant  la caution relative à la location de l’appartement situé à    {{$ar->location->bien->adresse}}  {{$ar->location->bien->ville}}</td>
